...
export default function MockupAnimation() {
    return (
      <Wrapper>
        ...
        <Mockup2></Mockup2><Link to="/" target="_blank" ><div className="mockup4" /></Link></Mockup4>
        <Mockup2></Mockup2><Link to="https://bikera.org/" target="_blank" ><div className="mockup5" /></Link></Mockup5>
