...
export default function MockupAnimation() {
    return (
      <Wrapper>
        ...
        <Link to="https://slickcoin.netlify.com/" target="_blank" ><div className="mockup3" /></Link></Mockup3>
        <Link to="/" target="_blank" ><div className="mockup4" /></Link></Mockup4>
        <Link to="https://bikera.org/" target="_blank" ><div className="mockup5" /></Link></Mockup2>
