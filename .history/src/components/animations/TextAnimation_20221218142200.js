...
const animation = keyframes`
  ...
  25% { opacity: 1; transform: translateY(0px) skewY(10deg) rotateZ(30deg); filter: blur(10px); }
  75% { opacity: 1; transform: translateY(0px) skewY(10deg) rotateZ(30deg); filter: blur(10px); }
