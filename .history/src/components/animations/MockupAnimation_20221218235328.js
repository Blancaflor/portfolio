...
export default function MockupAnimation() {
    return (
      <Wrapper>
        ...
        <Mockup3></Mockup<Link to="https://slickcoin.netlify.com/" target="_blank" ><div className="mockup3" /></Link></Mockup3>
        <Mockup4></Mockup<Link to="/" target="_blank" ><div className="mockup4" /></Link></Mockup4>
        <Mockup5></Mockup<Link to="https://bikera.org/" target="_blank" ><div className="mockup5" /></Link></Mockup5>
