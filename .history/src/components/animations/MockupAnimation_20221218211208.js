...
export default function MockupAnimation() {
    return (
      <Wrapper>
        <Mockup1><Link to="https://www.tupperwarelochristi.be/" target="_blank" ><div i className="mockup1" /></Link></Mockup1>
        <Mockup2><Link to="https://prosteam.be/" target="_blank" ><div i className="mockup2" /></Link></Mockup2>
        <Mockup3><Link to="https://slickcoin.netlify.com/" target="_blank" ><div i className="mockup3" /></Link></Mockup3>
        <Mockup4><Link to="/" target="_blank" ><div i className="mockup4" /></Link></Mockup4>
        <Mockup5><Link to="https://bikera.org/" target="_blank" ><div i className="mockup5" /></Link></Mockup5>
      </Wrapper>
  )
}
