...
const animation = keyframes`
  ...
  25% { opacity: 1; transform: translateY(0px) skewY(0deg) skewX(10deg) rotateZ(0deg); filter: blur(0px); }
  75% { opacity: 1; transform: translateY(0px) skewY(0deg) skewX(10deg) rotateZ(0deg); filter: blur(0px); }
