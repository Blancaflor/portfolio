    ...
    <Layout>
      ...
      <ContentWrapper>
        ...
        <div className="row pt-5 mx-auto">
          <div className="col-xs-7 col-sm-6 col-lg-8 form-group mx-auto">
            <input type="text" className="form-control" placeholder="Name" name="name" />
          </div>
          <div className="col-xs-7 col-sm-6 col-lg-8 form-group pt-2 mx-auto">
          ...
          <div className="col-xs-7 col-sm-6 col-lg-8 pt-3 mx-auto">
